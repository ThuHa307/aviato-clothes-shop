 ...
 * @author PC
 */
@WebServlet(name="GetSearchServlet", urlPatterns={"/search"})
public class GetSearchServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        ArrayList<Product> searchdata = p.searchAll(value);
    ...
    throws ServletException, IOException {
        ...
        ProductDAO p = new ProductDAO();
        ArrayList<Product> searchdata = p.search(value);
        request.setAttribute("searchdata", Product.removeDuplicateProducts(searchdata));
